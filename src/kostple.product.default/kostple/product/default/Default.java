package kostple.product.default;
...
public class Default {
	...
	public static void main(String[] args) {
		...
		configuration.addAnnotatedClass(KostPLE.pemesanan.core.PememesanComponent.class);
		configuration.addAnnotatedClass(KostPLE.pemesanan.core.PememesanDecorator.class);
		configuration.addAnnotatedClass(KostPLE.pemesanan.core.PememesanImpl.class);
	...
	public static void createObjectsAndBindEndPoints() {
        ...
        PememesanService pemesananPememesan2Service = PememesanServiceFactory
            .createPememesanService("KostPLE.pemesanan.core.PememesanServiceImpl"
            	);		
        ...
        PememesanResource pemesananPememesan2Resource = PememesanResourceFactory
            .createPememesanResource("KostPLE.pemesanan.core.PememesanResourceImpl"
                );
		...
		System.out.println("pemesananPememesan2Resource endpoints binding");
		Router.route(pemesananPememesan2Resource);
		
		System.out.println("pemesananPemesanan2Resource endpoints binding");
		Router.route(pemesananPemesanan2Resource);
		
		System.out.println("pemesananPememesan2Service endpoints binding");
		Router.route(pemesananPememesan2Service);
	...
	private static Map<String, Object> mappingFeatureModel() {
		...
		featureModelMappings.put(
			...
			new HashMap<String, String[]>() {{
				put("components", new String[] {
					KostPLE.pemesanan.core.PememesanComponent.class.getName(),
					KostPLE.pemesanan.core.PemesananComponent.class.getName()
				});
				put("deltas", new String[] {
				});
