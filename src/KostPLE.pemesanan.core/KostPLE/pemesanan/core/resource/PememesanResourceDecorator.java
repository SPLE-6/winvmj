...
public abstract class PememesanResourceDecorator extends PememesanResourceComponent{
	protected PememesanResourceComponent record;

    public PememesanResourceDecorator(PememesanResourceComponent record) {
        this.record = record;
    }
