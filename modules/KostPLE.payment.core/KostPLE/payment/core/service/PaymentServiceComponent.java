...
public abstract class PaymentServiceComponent implements PaymentService{
    ...
    public PaymentServiceComponent(){
        this.Repository = new RepositoryUtil<>(KostPLE.payment.core.PaymentComponent.class);
    }	

    public abstract List<HashMap<String,Object>> save(VMJExchange vmjExchange);
    public abstract PaymentImpl create(Map<String, Object> requestBody);
	public abstract PaymentImpl create(Map<String, Object> requestBody, Map<String, Object> response);    
